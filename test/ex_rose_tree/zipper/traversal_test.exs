defmodule ExRoseTree.Zipper.ZipperTest do
  ...
  describe "map/3" do
    test "should return new leaf Zipper if given an empty zipper with valid map_fn", %{empty_z: z} do
      map_fn = &ExRoseTree.set_term(&1, 2)
    ...
    test "should change only the focus and remain there if the move_fn returns nil immediately",
      ...
      map_fn = &ExRoseTree.map_term(&1, fn t -> t * 2 end)
  ...
  describe "forward_map/2" do
    ...
    test "should change every node of the Zipper that lies along the path, ending with a focus on last node visited",
      ...
      expected_z = %ExRoseTree.Zipper{
        focus: %ExRoseTree{term: 82, children: []},
        prev: [],
        next: [],
        path: [
          %ExRoseTree.Zipper.Location{
            prev: [
              %ExRoseTree{
                term: 56,
                children: [
                  %ExRoseTree{term: 78, children: []},
                  %ExRoseTree{term: 80, children: []}
                ]
              },
              %ExRoseTree{term: 54, children: []},
              %ExRoseTree{term: 52, children: []}
            ],
            term: 58,
            next: [%ExRoseTree{term: 60, children: []}]
          },
          %ExRoseTree.Zipper.Location{
            prev: [%ExRoseTree{term: 26, children: []}],
            term: 28,
            next: [%ExRoseTree{term: 30, children: []}]
          },
          %ExRoseTree.Zipper.Location{
            prev: [
              %ExRoseTree{term: 6, children: []},
              %ExRoseTree{
                ...
                children: [
                  %ExRoseTree{
                    ...
                    children: [
                      %ExRoseTree{term: 40, children: []},
                      %ExRoseTree{term: 42, children: []},
                      %ExRoseTree{
                        term: 44,
                        children: [
                          %ExRoseTree{term: 68, children: []},
                          %ExRoseTree{term: 70, children: []}
                        ]
                      }
                    ]
                  },
                  ...
                  %ExRoseTree{
                    ...
                    children: [
                      %ExRoseTree{
                        term: 46,
                        children: [
                          %ExRoseTree{term: 72, children: []},
                          %ExRoseTree{term: 74, children: []}
                        ]
                      },
                      %ExRoseTree{term: 48, children: []},
                      %ExRoseTree{
                        term: 50,
                        children: [%ExRoseTree{term: 76, children: []}]
                      }
                    ]
                  },
                  %ExRoseTree{term: 24, children: []}
                ]
              }
            ],
            term: 8,
            next: [
              %ExRoseTree{term: 10, children: [%ExRoseTree{term: 32, children: []}]},
              ...
              %ExRoseTree{
                ...
                children: [
                  %ExRoseTree{
                    term: 34,
                    children: [
                      %ExRoseTree{term: 62, children: []},
                      %ExRoseTree{term: 64, children: []}
                    ]
                  },
                  %ExRoseTree{term: 36, children: []},
                  %ExRoseTree{term: 38, children: [%ExRoseTree{term: 66, children: []}]}
                ]
              }
            ]
          },
          %ExRoseTree.Zipper.Location{
            prev: [%ExRoseTree{term: -1, children: []}],
            term: 0,
            next: [%ExRoseTree{term: 2, children: []}]
          }
        ]
      }
  ...
  describe "backward_map/2" do
    ...
    test "should change every node of the Zipper that lies along the path, ending with a focus on last node visited",
      ...
      expected_z = %ExRoseTree.Zipper{
        focus: %ExRoseTree{term: -2, children: []},
        prev: [],
        next: [
          %ExRoseTree{
            term: 0,
                ...
                children: [
                  ...
                  %ExRoseTree{
                    ...
                    children: [
                      ...
                      %ExRoseTree{
                        term: 58,
                        children: [%ExRoseTree{term: 82, children: []}]
                      },
                      %ExRoseTree{term: 60, children: []}
                    ]
                  },
                  %ExRoseTree{term: 30, children: []}
                ]
              },
              %ExRoseTree{term: 10, children: [%ExRoseTree{term: 32, children: []}]},
              %ExRoseTree{term: 12, children: []},
          ...
          %ExRoseTree{
            ...
            children: [
              %ExRoseTree{
                ...
                children: [
                  %ExRoseTree{
                    ...
                    children: [
                      %ExRoseTree{term: 20, children: []},
                      %ExRoseTree{term: 21, children: []},
                      %ExRoseTree{
                        term: 22,
                        children: [
                          %ExRoseTree{term: 34, children: []},
                          %ExRoseTree{term: 35, children: []}
                        ]
                      }
                    ]
                  },
                  ...
                  %ExRoseTree{
                    ...
                    children: [
                      %ExRoseTree{
                        ...
                        children: [
                          %ExRoseTree{term: 36, children: []},
                          %ExRoseTree{term: 37, children: []}
                        ]
                      },
                      %ExRoseTree{term: 24, children: []},
                      %ExRoseTree{
                        term: 25,
                        children: [%ExRoseTree{term: 38, children: []}]
                      }
                    ]
                  },
                  %ExRoseTree{term: 12, children: []}
              ...
              %ExRoseTree{
                term: 4,
                children: [
                  %ExRoseTree{term: 13, children: []},
                  %ExRoseTree{
                    term: 14,
                    children: [
                      %ExRoseTree{term: 26, children: []},
                      %ExRoseTree{term: 27, children: []},
                      %ExRoseTree{
                        term: 28,
                        children: [
                          %ExRoseTree{term: 39, children: []},
                          %ExRoseTree{term: 40, children: []}
                        ]
                      },
                      %ExRoseTree{
                        term: 29,
                        children: [%ExRoseTree{term: 41, children: []}]
                      },
                      %ExRoseTree{term: 30, children: []}
                    ]
                  },
                  %ExRoseTree{term: 15, children: []}
                ]
              },
              %ExRoseTree{term: 5, children: [%ExRoseTree{term: 16, children: []}]},
              %ExRoseTree{term: 6, children: []},
              %ExRoseTree{
                term: 7,
                children: [
                  %ExRoseTree{
                    term: 17,
                    children: [
                      %ExRoseTree{term: 31, children: []},
                      %ExRoseTree{term: 32, children: []}
                    ]
                  },
                  %ExRoseTree{term: 18, children: []},
                  %ExRoseTree{term: 19, children: [%ExRoseTree{term: 33, children: []}]}
                ]
              }
            ]
          },
                ...
                children: [
                  ...
                  %ExRoseTree{
                    ...
                    children: [
                      ...
                      %ExRoseTree{term: 28, children: []},
                      %ExRoseTree{
                        term: 30,
                        children: [%ExRoseTree{term: 32, children: []}]
                      }
                    ]
                  },
                  %ExRoseTree{term: 34, children: []}
              ...
              %ExRoseTree{
                ...
                children: [
                  ...
                  %ExRoseTree{
                    term: 42,
                    children: [
                      %ExRoseTree{term: 44, children: []},
                      %ExRoseTree{term: 46, children: []},
                      %ExRoseTree{
                        term: 48,
                        children: [
                          %ExRoseTree{term: 50, children: []},
                          %ExRoseTree{term: 52, children: []}
                        ]
                      },
                      %ExRoseTree{
                        term: 54,
                        children: [%ExRoseTree{term: 56, children: []}]
                      },
                      %ExRoseTree{term: 58, children: []}
                    ]
                  },
                  %ExRoseTree{term: 60, children: []}
                ]
              },
              %ExRoseTree{term: 62, children: [%ExRoseTree{term: 64, children: []}]},
              %ExRoseTree{term: 66, children: []},
              %ExRoseTree{
                term: 68,
                children: [
                  %ExRoseTree{
                  ...
                  %ExRoseTree{term: 76, children: []},
                  %ExRoseTree{term: 78, children: [%ExRoseTree{term: 80, children: []}]}
                ]
              }
            ]
          },
  ...
  describe "ascend_map/2" do
    ...
    test "should change only the focus and remain there if no depth-first ancestors",
         %{leaf_z: z} do
      map_fn = &ExRoseTree.map_term(&1, fn t -> t * 2 end)
    ...
    test "should change every node of the Zipper that lies along the path, ending with a focus on last node visited",
         %{z_depth_first_siblings_at_end: z} do
      map_fn = &ExRoseTree.map_term(&1, fn t -> t * 2 end)
      ...
      expected_z = %ExRoseTree.Zipper{
        ...
        next: [
          ...
          %ExRoseTree{term: 82, children: []}
        ],
        path: []
      }

      assert expected_z == Zipper.ascend_map(z, map_fn)
    end
  end
  ...
  describe "ascend_accumulate/3" do
    ...
    test "should return unmoved Zipper and accumulator if no depth-first ancestors",
         %{leaf_z: z} do
      acc_fn = fn next_z, acc ->
        case next_z.focus.term do
          nil ->
      ...
      assert {^z, [2]} = Zipper.ascend_accumulate(z, [], acc_fn)
    end
    ...
    test "should accumulate every node of the Zipper that lies along the path, ending with a focus on last node visited and the accumulated value",
                ...
                children: [
                  ...
                  %ExRoseTree{
                    ...
                    children: [
                      ...
                      %ExRoseTree{
                        term: 15,
                        children: [%ExRoseTree{term: 16, children: []}]
                      }
                    ]
                  },
                  %ExRoseTree{term: 17, children: []}
                ]
              },
              %ExRoseTree{term: 18, children: []},
              %ExRoseTree{
                ...
                children: [
                  ...
                  %ExRoseTree{
                    term: 21,
                    children: [
                      %ExRoseTree{term: 22, children: []},
                      %ExRoseTree{term: 23, children: []},
                      %ExRoseTree{
                        term: 24,
                        children: [
                          %ExRoseTree{term: 25, children: []},
                          %ExRoseTree{term: 26, children: []}
                        ]
                      },
                      %ExRoseTree{
                        term: 27,
                        children: [%ExRoseTree{term: 28, children: []}]
                      },
                      %ExRoseTree{term: 29, children: []}
                    ]
                  },
                  %ExRoseTree{term: 30, children: []}
                ]
              },
              %ExRoseTree{term: 31, children: [%ExRoseTree{term: 32, children: []}]},
              %ExRoseTree{term: 33, children: []},
              %ExRoseTree{
                term: 34,
                children: [
                  %ExRoseTree{
                  ...
                  %ExRoseTree{term: 38, children: []},
                  %ExRoseTree{term: 39, children: [%ExRoseTree{term: 40, children: []}]}
                ]
              }
            ]
          },
          %ExRoseTree{term: 41, children: []}
        ],
        path: []
      }
      ...
      assert {^expected_z, ^expected_acc} = Zipper.ascend_accumulate(z, [], acc_fn)
    end
  end
end
