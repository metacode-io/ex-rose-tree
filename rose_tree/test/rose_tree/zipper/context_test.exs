...
#     test "should return true when given a valid Context struct", %{all_zippers_with_idx: all} do
#       for {ctx, idx} <- all do
...
#     test "should return true when given an empty Context struct", %{empty_z: ctx} do
#       assert Context.empty?(ctx) == true
#     end

#     test "should return false when given a non-empty Context struct", %{simple_z: ctx} do
...
#     test "should return true when given a Context with an empty path", %{simple_z: ctx} do
...
#     test "should return true when given a Context whose focus has children", %{simple_z: ctx} do
#       assert Context.has_children?(ctx) == true
#     end

#     test "should return false when given a Context whose focus has no children", %{leaf_z: ctx} do
...
#          %{simple_z: ctx, simple_tree: tree} do
...
#     test "should return nil if given a Context with no parent", %{simple_z: ctx} do
#       assert nil == Context.index_of_parent(ctx)
#     end

#     test "should return 0 if parent has no siblings", %{z_with_parent: ctx} do
...
#     test "should return nil if given a Context with no grandparent", %{z_with_parent: ctx} do
#       assert nil == Context.index_of_grandparent(ctx)
#     end

#     test "should return 0 if grandparent has no siblings", %{z_with_grandparent: ctx} do
#       assert 0 == Context.index_of_grandparent(ctx)
#     end
#   end

#   describe "parent_location/1" do
#     test "should return nil if given a root Context", %{simple_z: ctx} do
...
#       assert_raise(ArgumentError, fn -> Context.map_path(new_ctx, map_fn) end)
#     end
#   end
# end
